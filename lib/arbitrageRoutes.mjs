  ...
  function startCampaignAuto(campaignId, sessionId, thresholdCents, cooldownSec, swapPoly, recurring, recurringType, earlyExit = false, exitThresholdCents = 4, maxShares = GLOBAL_MAX_SHARES, polyOnlyInput = false) {
    ...
    async function tick() {
      ...
      if (sess.polyOnlyInput) {
        ...
        if (profitA >= threshold && costA <= 0.97 && profitA >= profitB) bestStrategy = 'A';
        else if (profitB >= threshold && costB <= 0.97) bestStrategy = 'B';
        ...
        if (!clob) {
          ...
          await pool.query(
            ...
            [
              ...
              ksYesBid, ksYesAsk, ksNoBid, ksNoAsk, polyUpAsk, polyDownAsk, sigDiv, sigSpread, 'taker', eventId,
            ],
